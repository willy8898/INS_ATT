...
if __name__ == '__main__':    
    ...
    #path='/media/1TB_HDD/kitti_ins_aux/KITTI_ins_subscene/'
    #path = '/media/1TB_HDD/kitti_ins_aux_unify_background/'
    #path = '/media/1TB_HDD/kitti_ins_aux_unify_background_16/'
